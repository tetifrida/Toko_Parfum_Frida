...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/bg_parfum.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Toko Hyohyo</h1>
            <h2 class="subheading mb-4">“Perfume is that last and best reserve of the past, the one which when all our tears have run dry, can make us cry again!” – Marcel Proust</h2>
